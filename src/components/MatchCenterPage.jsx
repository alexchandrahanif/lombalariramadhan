...
const MatchCenterPage = () => {
	...
	return <div className="match-page">
		...
		<main>
			<section className="match-hero"><div><span className="match-eyebrow"><Trophy /> Pusat Pertandingan</span><h1>Match<br/><em>Center.</em></h1><p>Jadwal, hasil pertandingan, statistik pemain, dan kabar terbaru Pemuda Cup III dalam satu tempat.</p><div className="match-hero__meta"><span><MapPin /> Lapangan Putri Hijau</span><span><CalendarDays /> 2–12 September 2026</span></div></div><div className="match-hero__logo" aria-label="Pemuda Cup III Sintong 2026"><span>Turnamen Mini Soccer</span><img src={eventLogo} alt="Logo Pemuda Cup III Sintong" /><strong>Pemuda Cup III</strong><small>Sintong · 2026</small></div></section>
			<section className="match-section" id="pertandingan">
				...
				<div className="match-date-filter"><label htmlFor="match-date"><CalendarDays /> Pilih Tanggal</label><input id="match-date" type="date" value={selectedDate} min="2026-09-02" max="2026-09-12" onChange={(event) => setSelectedDate(event.target.value)} /><strong>{dateLabel(selectedDate)}</strong></div>
