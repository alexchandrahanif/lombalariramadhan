...
const QuarterFinalPage = () => <div className="knockout-page">
	...
	<main>
		<section className="knockout-hero"><div><span className="knockout-eyebrow"><Trophy /> Road to the Final</span><h1>Babak<br/><em>8 Besar.</em></h1><p>Delapan tim terbaik. Sistem gugur. Satu jalan menuju trofi Pemuda Cup III Sintong 2026.</p><div className="knockout-hero__meta"><span><MapPin /> Lapangan Putri Hijau</span><span><CalendarDays /> 14–19 September 2026</span></div></div><div className="knockout-trophy"><span>8</span><img src={eventLogo} alt="Logo Pemuda Cup III" /><strong>TEAMS</strong><small>ONE CHAMPION</small></div></section>
		...
		<section className="knockout-section"><div className="knockout-heading"><div><span>Knockout Stage</span><h2>Championship Bracket</h2></div><p>Pemenang setiap pertandingan melaju. Tidak ada kesempatan kedua.</p></div>
			<div className="knockout-board">
				...
				<section className="knockout-column knockout-column--final"><header><span>03</span><div><small>Panggung Utama</small><h3>Final</h3></div><b>2 Laga</b></header><div className="knockout-stack knockout-stack--center"><PlaceholderMatch match={{ stage:'Perebutan Posisi 3', date:'Sabtu, 19 September 2026', time:'15:25 WIB', teams:[{ name:'Elthar FC', logo:eltharLogo },{ name:'08 Rokan Farm', logo:rokanFarmLogo }] }} /><article className="knockout-card knockout-card--champion"><Trophy /><span>Grand Final</span><h3>Sabtu, 19 September 2026</h3><b>16:40 WIB</b><div><strong>Bescemp Poss x Ruwo B</strong><i>VS</i><strong>Al-Qarny x Suang Sadu</strong></div></article></div></section>
			</div>
